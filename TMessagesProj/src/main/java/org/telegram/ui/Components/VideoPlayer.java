...
import org.telegram.kboimessenger.exoplayer2.Player;
import org.telegram.kboimessenger.exoplayer2.source.LoopingMediaSource;
import org.telegram.kboimessenger.secretmedia.ExtendedDefaultDataSourceFactory;
import org.telegram.kboimessenger.ApplicationLoader;
import org.telegram.kboimessenger.exoplayer2.DefaultLoadControl;
import org.telegram.kboimessenger.exoplayer2.DefaultRenderersFactory;
import org.telegram.kboimessenger.exoplayer2.ExoPlaybackException;
import org.telegram.kboimessenger.exoplayer2.ExoPlayer;
import org.telegram.kboimessenger.exoplayer2.ExoPlayerFactory;
import org.telegram.kboimessenger.exoplayer2.PlaybackParameters;
import org.telegram.kboimessenger.exoplayer2.SimpleExoPlayer;
import org.telegram.kboimessenger.exoplayer2.Timeline;
import org.telegram.kboimessenger.exoplayer2.extractor.DefaultExtractorsFactory;
import org.telegram.kboimessenger.exoplayer2.source.ExtractorMediaSource;
import org.telegram.kboimessenger.exoplayer2.source.MediaSource;
import org.telegram.kboimessenger.exoplayer2.source.TrackGroupArray;
import org.telegram.kboimessenger.exoplayer2.source.dash.DashMediaSource;
import org.telegram.kboimessenger.exoplayer2.source.dash.DefaultDashChunkSource;
import org.telegram.kboimessenger.exoplayer2.source.hls.HlsMediaSource;
import org.telegram.kboimessenger.exoplayer2.source.smoothstreaming.DefaultSsChunkSource;
import org.telegram.kboimessenger.exoplayer2.source.smoothstreaming.SsMediaSource;
import org.telegram.kboimessenger.exoplayer2.trackselection.AdaptiveTrackSelection;
import org.telegram.kboimessenger.exoplayer2.trackselection.DefaultTrackSelector;
import org.telegram.kboimessenger.exoplayer2.trackselection.MappingTrackSelector;
import org.telegram.kboimessenger.exoplayer2.trackselection.TrackSelection;
import org.telegram.kboimessenger.exoplayer2.trackselection.TrackSelectionArray;
import org.telegram.kboimessenger.exoplayer2.upstream.DataSource;
import org.telegram.kboimessenger.exoplayer2.upstream.DefaultBandwidthMeter;
import org.telegram.kboimessenger.exoplayer2.upstream.DefaultHttpDataSourceFactory;
