...
import org.telegram.kboimessenger.LocationController;
...
import org.telegram.kboimessenger.NativeCrashManager;
...
import org.telegram.kboimessenger.camera.CameraController;
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                    ...
                    } else if (intent.getAction().equals("org.telegram.kboimessenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
