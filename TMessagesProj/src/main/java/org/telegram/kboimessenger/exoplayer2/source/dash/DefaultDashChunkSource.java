 ...
 */
package org.telegram.kboimessenger.exoplayer2.source.dash;

import android.net.Uri;
import android.os.SystemClock;
import org.telegram.kboimessenger.exoplayer2.C;
import org.telegram.kboimessenger.exoplayer2.Format;
import org.telegram.kboimessenger.exoplayer2.extractor.ChunkIndex;
import org.telegram.kboimessenger.exoplayer2.extractor.Extractor;
import org.telegram.kboimessenger.exoplayer2.extractor.SeekMap;
import org.telegram.kboimessenger.exoplayer2.extractor.mkv.MatroskaExtractor;
import org.telegram.kboimessenger.exoplayer2.extractor.mp4.FragmentedMp4Extractor;
import org.telegram.kboimessenger.exoplayer2.extractor.rawcc.RawCcExtractor;
import org.telegram.kboimessenger.exoplayer2.source.BehindLiveWindowException;
import org.telegram.kboimessenger.exoplayer2.source.chunk.Chunk;
import org.telegram.kboimessenger.exoplayer2.source.chunk.ChunkExtractorWrapper;
import org.telegram.kboimessenger.exoplayer2.source.chunk.ChunkHolder;
import org.telegram.kboimessenger.exoplayer2.source.chunk.ChunkedTrackBlacklistUtil;
import org.telegram.kboimessenger.exoplayer2.source.chunk.ContainerMediaChunk;
import org.telegram.kboimessenger.exoplayer2.source.chunk.InitializationChunk;
import org.telegram.kboimessenger.exoplayer2.source.chunk.MediaChunk;
import org.telegram.kboimessenger.exoplayer2.source.chunk.SingleSampleMediaChunk;
import org.telegram.kboimessenger.exoplayer2.source.dash.manifest.AdaptationSet;
import org.telegram.kboimessenger.exoplayer2.source.dash.manifest.DashManifest;
import org.telegram.kboimessenger.exoplayer2.source.dash.manifest.RangedUri;
import org.telegram.kboimessenger.exoplayer2.source.dash.manifest.Representation;
import org.telegram.kboimessenger.exoplayer2.trackselection.TrackSelection;
import org.telegram.kboimessenger.exoplayer2.upstream.DataSource;
import org.telegram.kboimessenger.exoplayer2.upstream.DataSpec;
import org.telegram.kboimessenger.exoplayer2.upstream.HttpDataSource.InvalidResponseCodeException;
import org.telegram.kboimessenger.exoplayer2.upstream.LoaderErrorThrower;
import org.telegram.kboimessenger.exoplayer2.util.MimeTypes;
import org.telegram.kboimessenger.exoplayer2.util.Util;
