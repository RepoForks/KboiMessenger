...
import org.telegram.kboimessenger.exoplayer2.ExoPlayerLibraryInfo;
import org.telegram.kboimessenger.exoplayer2.ParserException;
import org.telegram.kboimessenger.exoplayer2.Timeline;
import org.telegram.kboimessenger.exoplayer2.source.AdaptiveMediaSourceEventListener;
import org.telegram.kboimessenger.exoplayer2.source.AdaptiveMediaSourceEventListener.EventDispatcher;
import org.telegram.kboimessenger.exoplayer2.source.MediaPeriod;
...
import org.telegram.kboimessenger.exoplayer2.source.dash.manifest.DashManifestParser;
import org.telegram.kboimessenger.exoplayer2.source.dash.manifest.UtcTimingElement;
...
import org.telegram.kboimessenger.exoplayer2.upstream.ParsingLoadable;
...
public final class DashMediaSource implements MediaSource {
  ...
  private static final class PeriodSeekInfo {
    ...
    public static PeriodSeekInfo createPeriodSeekInfo(
            org.telegram.kboimessenger.exoplayer2.source.dash.manifest.Period period, long durationUs) {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      org.telegram.kboimessenger.exoplayer2.source.dash.manifest.Period period =
